...
# Linked services
WORKBOARD_API_URL = 'http://%s:%s' % (os.environ.get('WORKBOARD_API_PORT_80_TCP_ADDR'), os.environ.get('WORKBOARD_API_PORT_80_TCP_PORT'))
...
#Single sign on
APPLICATION_URL     = 'http://workboard-front.notasquare.local'

OAUTH_CLIENT_EK      = 'DD52AFE1658490C7D5824E0E61F915D4AB104452'
OAUTH_COOKIE_NAME    = '_gpadmin_jwt_dev'
OAUTH_USER_JWT_DEBUG = {
    'id':             1,
    'username':       'ttduy',
    'name':           'ttduy',
    'email':          'ttduy@notasquare.vn',
}
SECURITY_SERVER_URL = 'http://security-server-admin.genopedia.local'
